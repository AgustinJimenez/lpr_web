    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-4"><button class="btn-primary btn-flat" id="select_all">Seleccionar todos</button><br><br><button type="submit" class="btn btn-primary btn-flat">{{ trans('user::button.update') }}</button></div>
                <script type="text/javascript">
                    $("#select_all").click(function (event)
                    {
                        $(".jsSelectAllInGroup").click();
